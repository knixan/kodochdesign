        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-5xl md:text-6xl font-bold">
              Vi skapar din{" "}
              <span className="gradient-text text-pink-400">
                Digitala Lösning
              </span>
            </h2>
            <p className="text-gray-300 text-lg">
              Hemsidor, webbapplikationer & design – skräddarsytt efter dina
              behov
            </p>
              ...
              <div className="relative w-full h-full rounded-full border-2 border-white/10 backdrop-blur-xl bg-white/5 flex items-center justify-center">
                <div className="text-center space-y-4">
                  <Image
                    ...
                    width={600}
                    height={400}
                    className="w-58 h-auto object-contain mx-auto"
                  />
                  <p className="text-sm text-slate-400 font-light">
                    Webb &bull; Design &bull; Kod
                  </p>
                </div>
              </div>
            </div>
